...
func (qc *QueueCreate) SetOwnerID(id int) *QueueCreate {
	qc.mutation.SetOwnerID(id)
	return qc
}

// SetNillableOwnerID sets the owner edge to User by id if the given value is not nil.
func (qc *QueueCreate) SetNillableOwnerID(id *int) *QueueCreate {
	if id != nil {
		qc = qc.SetOwnerID(*id)
	}
	return qc
...
func (qc *QueueCreate) SetOwner(u *User) *QueueCreate {
