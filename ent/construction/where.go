...
func ProductionIn(vs ...float64) predicate.Construction {
	...
	return predicate.Construction(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldProduction), v...))
	})
}
...
func ProductionNotIn(vs ...float64) predicate.Construction {
	...
	return predicate.Construction(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldProduction), v...))
	})
}
...
func HasOwner() predicate.Construction {
	return predicate.Construction(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasOwnerWith(preds ...predicate.User) predicate.Construction {
	return predicate.Construction(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasQueueWith(preds ...predicate.QueueItem) predicate.Construction {
	return predicate.Construction(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasAffects applies the HasEdge predicate on the "affects" edge.
func HasAffects() predicate.Construction {
	return predicate.Construction(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(AffectsTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, AffectsTable, AffectsPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasAffectsWith applies the HasEdge predicate on the "affects" edge with a given conditions (other predicates).
func HasAffectsWith(preds ...predicate.Construction) predicate.Construction {
	return predicate.Construction(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasAffectedBy applies the HasEdge predicate on the "affected_by" edge.
func HasAffectedBy() predicate.Construction {
	return predicate.Construction(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(AffectedByTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, AffectedByTable, AffectedByPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasAffectedByWith applies the HasEdge predicate on the "affected_by" edge with a given conditions (other predicates).
func HasAffectedByWith(preds ...predicate.Construction) predicate.Construction {
	return predicate.Construction(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(Table, FieldID),
