...
func (qi *QueueItem) assignValues(values ...interface{}) error {
	...
	if value, ok := values[0].(*sql.NullInt64); !ok {
		return fmt.Errorf("unexpected type %T for field duration", values[0])
	} else if value.Valid {
...
func (qi *QueueItem) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", qi.Position))
	builder.WriteByte(')')
