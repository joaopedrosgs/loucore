...
// OldCompletion returns the old completion value of the Queue.
...
// OldAction returns the old action value of the Queue.
// If the Queue object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
...
// OldOrder returns the old order value of the Queue.
// If the Queue object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
...
// SetOwnerID sets the owner edge to User by id.
func (m *QueueMutation) SetOwnerID(id int) {
	m.owner = &id
}

// ClearOwner clears the owner edge to User.
func (m *QueueMutation) ClearOwner() {
	m.clearedowner = true
}

// OwnerCleared returns if the edge owner was cleared.
func (m *QueueMutation) OwnerCleared() bool {
	return m.clearedowner
}

// OwnerID returns the owner id in the mutation.
func (m *QueueMutation) OwnerID() (id int, exists bool) {
	if m.owner != nil {
		return *m.owner, true
	}
	return
...
// Note that ids always returns len(ids) <= 1 for unique edges, and you should use
// OwnerID instead. It exists only for internal usage by the builders.
func (m *QueueMutation) OwnerIDs() (ids []int) {
	if id := m.owner; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetOwner reset all changes of the "owner" edge.
func (m *QueueMutation) ResetOwner() {
	m.owner = nil
	m.clearedowner = false
}
...
func (m *QueueMutation) AddedEdges() []string {
	edges := make([]string, 0, 3)
	if m.owner != nil {
		edges = append(edges, queue.EdgeOwner)
	}
	if m.city != nil {
